...
public class AdvancedTableToPDF {
	...
	private static void createPDF(OfficeDocumentConverter converter) {
		try {
			...
			converter.convert(new File("docx/AdvancedTable.docx"), new File("pdf/AdvancedTable.pdf"));
			System.err.println("Generate pdf/AdvancedTable.pdf with " + (System.currentTimeMillis() - start) + "ms");
		} catch (Throwable e) {
			e.printStackTrace();
		}
	}
